...
- **Desde el celular, en GitHub:** abrir este repositorio en el navegador
  (versión de escritorio), entrar a `clientes/50-doctors-la-paz/logotipos`,
  «Add file» → «Upload files», elegir las imágenes y confirmar en la rama
  `claude/hemotrack-50doctors-demo-yj3iwu`.
- **En la conversación con Claude:** adjuntar la imagen y pedir que la guarde aquí.
